...
const styles: Record<string, React.CSSProperties> = {
  ...
  lockedTitle: { fontSize: font.size.lg, fontWeight: 600, marginBottom: space.sm },
  lockedBody: {
    color: colors.textSoft,
    fontSize: font.size.sm,
    lineHeight: 1.6,
  ...
  profileMeta: { fontSize: font.size.xs, color: colors.textMuted, marginTop: 4 },
  fullProfile: {
    display: 'flex',
  ...
  orderId: { fontSize: font.size.xs, color: colors.textSoft, minWidth: 80 },
  orderTotal: { fontSize: font.size.sm, color: colors.text, textAlign: 'right' },
  orderDate: { fontSize: font.size.xs, color: colors.textMuted },
  medicalCard: {
    background: colors.bg,
    border: `1px solid ${colors.border}`,
    borderRadius: radius.md,
